...
public class RequestsFragment extends Fragment
{
                        ...
                        if (dataSnapshot.exists())
                        {
                                ...
                                UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                    {
                                       if (dataSnapshot.hasChild("image"))
                                       {
                                           ...
                                           final String requestProfile = dataSnapshot.child("image").getValue().toString();

                                           Picasso.get().load(requestProfile).into(holder.profileImage);
                            ...
                            else
                            {
                                if (type.equals("sent"))
                                {
                                    ...
                                    holder.itemView.findViewById(R.id.requests_accept_btn).setVisibility(View.INVISIBLE);
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public RequestsViewHolder(@NonNull View itemView) {
            ...
            Accept = itemView.findViewById(R.id.requests_accept_btn);
            Cancel = itemView.findViewById(R.id.requests_cancel_btn);
