                      ...
                      if (dataSnapshot.exists())
                      {
                          ...
                          holder.Calling.setOnClickListener(new View.OnClickListener() {
                              ...
                              public void onClick(View v) {
                                  Intent itentCall = new Intent(getActivity(),CallingActivity.class);
                                  itentCall.putExtra("visit_user_id",userIDs);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.hasChild("ringing"))
                        {
                            ...
                            Intent callingitent = new Intent(getActivity(),CallingActivity.class);
                            callingitent.putExtra("visit_user_id",calledBy);
