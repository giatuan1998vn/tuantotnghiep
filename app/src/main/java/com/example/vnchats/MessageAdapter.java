    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int postion)
    {
        ...
        else if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            if (fromUserID.equals(messageSenderID))
            {
               ...
               Picasso.get()
                       .load("https://firebasestorage.googleapis.com/v0/b/whatsapp-7a443.appspot.com/o/Image%20Files%2Ffile.png?alt=media&token=60b11a46-4e84-4e33-9492-47c027739784")
